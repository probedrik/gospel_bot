...
class AISettingsManager:
    ...
    def _convert_value(self, str_value: str, setting_type: str) -> Any:
        ...
        try:
            ...
            logger.warning(f"Не удалось конвертировать значение '{str_value}' в тип '{setting_type}'")
            return str_value
    ...
    async def get_free_premium_users(self) -> set:
        ...
        try:
            ...
            logger.warning("Ошибка парсинга списка бесплатных премиум пользователей")
            return set()
