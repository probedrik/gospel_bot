...
async def settings_help(callback: CallbackQuery, state: FSMContext):
    ...
    help_text = (
        ...
        "📖 **Чтение Библии:**\n"
        "• Все 66 книг в разных переводах\n"
        "• Поиск стихов: `Ин 3:16`, `Мф 5:3-12`, `Ин 3:16-4:18`\n"
        "• Поиск целых глав: `Быт 1` или `Быт 1-3`\n"
        "• Навигация по главам с кнопками\n\n"

        "🤖 **ИИ помощник (3 запроса/день):**\n"
        "• Разбор стихов и глав\n"
        "• Подбор стихов по жизненным ситуациям\n"
        "• Объяснение библейских тем\n"
        "• Автообновление лимитов в полночь\n\n"

        "📝 **Закладки:**\n"
        "• Сохранение любых отрывков одним нажатием\n"
        "• Личные заметки к закладкам\n"
        "• Сохранение разборов ИИ\n"
        "• Удобная пагинация и поиск\n\n"
        ...
        "🎯 **Библейские темы:**\n"
        "• Готовые тематические подборки\n"
        "• ИИ-помощник для подбора стихов\n"
        "• Изучение по категориям\n\n"

        "📅 **Православный календарь:**\n"
        "• Праздники и памятные даты\n"
        "• Посты и богослужения\n"
        "• Святцы на каждый день\n\n"

        "🔍 **Поиск по слову:**\n"
        "• Поиск любых слов в Библии\n"
